...
# without_loo
fit_without_loo=run_fit(include_loo=0,data_for_stan=data_for_stan,iter_sampling=10,iter_warmup=10,chains=2)
# save
...
# with_loo
fit_with_loo=run_fit(include_loo=1,data_for_stan=data_for_stan,iter_sampling=10,iter_warmup=10,chains=2)
